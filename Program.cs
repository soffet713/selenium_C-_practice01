...
namespace KTW_VS_Selenium
{
    class Program
    {
        static void Main(string[] args)
        {
            //test_projects_page();
            //test_wordpress_page();
            Selenium_Web_Tests wt = new Selenium_Web_Tests();
            Application.Run(wt);

            //void test_projects_page()
            //{
            ...
            //void test_wordpress_page()
            //{
            //    WordPressPage wp_page = new WordPressPage();
            //    wp_page.Manage().Window.Maximize();
            //    wp_page.Navigate().GoToUrl("http://killertechwolf.com/SeanProjects/Index.html");
            //    wp_page.FindElementById("Wordpress_page").Click();
